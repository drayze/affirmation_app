...
As for features, it starts with the affirmation. Next I have 4 set themes (the 4 Seasons). An adjustable and cancelable daily local notification as a reminder, because we can use a little push sometimes. An Image handling and camera feature to add a picture as a custom background. Images can do a lot for the mind, body, and spirit.