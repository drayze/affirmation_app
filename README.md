...
As for features, it starts with the affirmation. Next to that a wide range od color schemes to give users the ablity to see colors they enjoy not the colors selected for them. Also, to display the date and time and I plan to incorporate some animations to give a little joy to the day.
