...
class AffirmationProvider {
  ...
  factory AffirmationProvider.withDefaultAffirmations() {
    return AffirmationProvider([
      ...
      "I will get to where you want to be. I have to just keep going.",
      "My opinions aren't tattoos. You can change them anytime.",
      "You are not one thing. You are a million amazing things.",
      ...
      "Don't take anyone's negativity. You deserve respect, all the time.",
